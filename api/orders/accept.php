...
try {
    ...
    // Enviar push notification con OneSignal
    try {
        $notificationService = new NotificationService();
        $notificationService->notifyOrderAccepted($order, $partner);
    } catch (Exception $e) {
        appLog("Error enviando push notification: " . $e->getMessage(), 'warning');
    }
