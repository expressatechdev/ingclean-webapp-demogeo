...
define('STRIPE_TEST_PUBLIC_KEY', 'pk_test_XXXXXXXXXXXXXXXXXXXXXXXXX');
define('STRIPE_TEST_SECRET_KEY', 'sk_test_XXXXXXXXXXXXXXXXXXXXXXXXX');
...
define('GOOGLE_MAPS_API_KEY', 'AIzaSyXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
...
define('ONESIGNAL_REST_API_KEY', 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');

// Safari Web ID (opcional, para notificaciones en Safari)
define('ONESIGNAL_SAFARI_WEB_ID', 'web.onesignal.auto.xxxxxx');
